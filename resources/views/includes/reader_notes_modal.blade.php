<div class="modal fade" id="modalReader" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Meine Notizen</h5>
            ...
            <div class="modal-body">
                ...
                @empty
                    Noch keine Notizen, erstelle eine Notiz indem du einen Testteil markierst und auf die Sprechblase klickst.
                @endforelse
